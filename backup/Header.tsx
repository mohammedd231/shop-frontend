...
const Header: React.FC = () => {
  ...
  // Debug logging
  console.log('🔍 Debug - Header render - userIsAdmin:', userIsAdmin);
  console.log('🔍 Debug - Header render - isAuthenticated:', isAuthenticated);
  console.log('🔍 Debug - Header render - user:', user);
            ...
            <nav className="flex items-center space-x-8">
              ...
              {isAuthenticated && (
                <>
                  ...
                  {userIsAdmin && (
                    <>
                      <Link to="/admin/products" className="text-gray-700 hover:text-blue-600 transition-colors font-medium bg-blue-50 px-3 py-1 rounded-lg">
                        📊 Admin Products
                      </Link>
                      <Link to="/admin/orders" className="text-gray-700 hover:text-blue-600 transition-colors font-medium bg-blue-50 px-3 py-1 rounded-lg">
                        📋 Admin Orders
                      </Link>
                    </>
                  )}
